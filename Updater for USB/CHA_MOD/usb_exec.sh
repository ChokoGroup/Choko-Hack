...
then
  ...
  then
    ...
    rm "/.choko/Activate Choko Hack USB Loader"*
    rm "/.choko/Restore USB Joystick Mode"*
    ...
    chmod 644 /.choko/*
    chmod 755 /.choko/*.sh
    chmod 755 /.choko/S19chokohelper.choko
    chmod 755 /.choko/S20joystick.choko
    chmod 755 /.choko/S21capcom.choko
    chmod 755 /etc
